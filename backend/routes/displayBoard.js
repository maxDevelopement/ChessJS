...
function checkCaseExist(array, x, y){
    const selectedCase = array.filter((caseItem) => caseItem.xPosition === x && caseItem.yPosition === y)
    if(selectedCase){ // case exist dans le tableau de jeu
        return selectedCase
    }else{
        return false
    }
...
module.exports = { createNewGame, checkCaseExist, checkGoodColorCase }
